...
export default function LoginPage() {
  ...
  return (
    <div className="animate-slide-up space-y-8">
      ...
      <div>
        <h1 className="font-black text-3xl tracking-tight">Sign in</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="pt-2">
          <button
            ...
            className="btn-press w-full py-3 bg-ink dark:bg-white text-white dark:text-ink font-bold text-sm border-2 border-ink dark:border-white shadow-brutal dark:shadow-brutal-dark transition-all disabled:opacity-60"
          >
            {loading ? (
      ...
      <p className="text-sm text-[rgb(var(--ink-muted))]">
        No account?{" "}
        <Link href="/auth/signup" className="font-bold text-[rgb(var(--ink))] underline underline-offset-2 hover:text-brand-600 dark:hover:text-brand-400 transition-colors">
          Create one
        </Link>
      </p>
    </div>
